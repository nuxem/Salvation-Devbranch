...
while { true } do {
	...
	_scanned_units = [ allUnits, { ( alive _x ) && ( side group _x == FCLIB_side_friendly ) } ] call BIS_fnc_conditionalSelect;
	...
	FCLIB_nametag_units = [] + _scanned_units;
	...
	FCLIB_overlay_groups = [] + _scanned_groups;
