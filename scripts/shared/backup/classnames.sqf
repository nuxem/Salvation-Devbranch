...
air_vehicles = [
	...
	["B_T_VTOL_01_armed_F",0,1000,75],
	["B_UAV_02_CAS_F",0,250,20],
	["B_T_UAV_03_F",0,300,30]
];
...
if ( isNil "opfor_heavygunner") then { opfor_heavygunner = ""; };
...
military_alphabet = ["Alpha","Bravo","Charlie","Delta","Echo","Foxtrot","Golf","Hotel","India","Juliet","Kilo","Lima","Mike","November","Oscar","Papa","Quebec","Romeo","Sierra","Tango","Uniform","Victor","Whiskey","X-Ray","Yankee","Zulu","Shit man too many FoBs"];
