...
if ( isNil "elite_vehicles_extension" ) then { elite_vehicles_extension = [] }; elite_vehicles = [] + elite_vehicles_extension + [ "B_T_MBT_01_mlrs_F","B_Heli_Attack_01_F","B_T_MBT_01_TUSK_F","B_T_MBT_01_cannon_F","B_T_MBT_01_arty_F","B_Plane_CAS_01_F","B_UAV_02_F","B_UAV_02_CAS_F","B_T_UAV_03_F","B_T_VTOL_01_armed_F" ];
...
if ( isNil "opfor_medic") then { opfor_medic = "O_T_Soldier_Medic_F"; };
...
if ( isNil "opfor_engineer") then { opfor_engineer = "O_T_Engineer_F_"; };
if ( isNil "opfor_paratrooper") then { opfor_paratrooper = "O_T_Soldier_PG_F"; };
if ( isNil "opspec_rifleman") then { opspec_rifleman = "O_V_Soldier_ghex_F"; };
if ( isNil "opspec_marksman") then { opspec_marksman = "O_V_Soldier_M_ghex_F"; };
if ( isNil "opspec_teamleader") then { opspec_teamleader = "O_V_Soldier_TL_ghex_F"; };
if ( isNil "opspec_medic") then { opspec_medic = "O_V_Soldier_Medic_ghex_F"; };
if ( isNil "opspec_explosive") then { opspec_explosive = "O_V_Soldier_Exp_ghex_F"; };
if ( isNil "opspec_at") then { opspec_at = "O_V_Soldier_LAT_ghex_F"; };
...
military_alphabet = ["Alpha","Bravo","Charlie","Delta","Echo","Foxtrot","Golf","Hotel","India","Juliet","Kilo","Lima","Mike","November","Oscar","Papa","Quebec","Romeo","Sierra","Tango","Uniform","Victor","Whiskey","X-Ray","Yankee","Zulu","Just STOP and win already"];
...
opfor_squad_8_standard = [opfor_squad_leader,opfor_team_leader,opfor_machinegunner,opfor_machinegunner,opfor_medic,opfor_marksman,opfor_grenadier,opfor_rpg];
opfor_squad_8_infkillers = [opfor_squad_leader,opfor_machinegunner,opfor_machinegunner,opfor_machinegunner,opfor_medic,opfor_marksman,opfor_sharpshooter,opfor_sniper];
...
opfor_squad_8_vipers = [opspec_teamleader,opspec_rifleman,opspec_rifleman,opspec_medic,opspec_marksman,opspec_at,opspec_marksman,opspec_explosive];
