...
if ( _building_ai_max > floor ((count _buildingpositions) * FCLIB_defended_buildingpos_part)) then { _building_ai_max = floor ((count _buildingpositions) * FCLIB_defended_buildingpos_part)};
_squadtospawnnn = [];
