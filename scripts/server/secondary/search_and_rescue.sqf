...
private _helowreck = FCLIB_sar_wreck createVehicle _helopos;
...
private _helofire = FCLIB_sar_fire createVehicle (getpos _helowreck);
_helofire setpos (getpos _helowreck);
_helofire setpos (getpos _helowreck);

private _pilotsGrp = createGroup FCLIB_side_enemy;
...
private _grppatrol = createGroup FCLIB_side_enemy;
...
private _grpsentry = createGroup FCLIB_side_enemy;
...
sleep 1;
FCLIB_secondary_in_progress = 2; publicVariable "FCLIB_secondary_in_progress";
...
if ( _alive_crew_count == 0 ) then {
	...
	private _grp = createGroup FCLIB_side_friendly;
...
FCLIB_secondary_in_progress = -1; publicVariable "FCLIB_secondary_in_progress";
sleep 1;
