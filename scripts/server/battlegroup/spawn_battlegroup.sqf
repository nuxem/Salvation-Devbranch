...
if ( _spawn_marker != "" ) then {
	...
	FCLIB_last_battlegroup_time = time;

	_selected_opfor_battlegroup = [];
	_target_size = FCLIB_battlegroup_size * ([] call F_adaptiveOpforFactor) * (sqrt FCLIB_csat_aggressivity);
